...
class rtdetr_heatmap:
    def __init__(self, weight, device, method, layer, backward_type, conf_threshold, ratio, show_box, renormalize):
        ...
        def reshape_transform(x):
            # 如果是 Transformer 输出，可能需要在此处 reshape
            # 先试着简单返回，如果不行再调整
            return x

        method = eval(method)(model, target_layers, reshape_transform=reshape_transform)
    ...
    def __call__(self, img_path, save_path):
        ...
        if os.path.isdir(img_path):
            ...
            self.process(img_path, f'{save_path}/R18.png')

def get_params():
    params = {
        'weight': r'C:\Users\86181\Desktop\RTDETR-main\runsx\train\pcb\rtdetr-C\weights\best.pt',
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model(r"C:\Users\86181\Desktop\RTDETR-main\datasets_pcb完整 - 加工版模糊版\images\val", r"C:\Users\86181\Desktop\热力图casa")