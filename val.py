...
if __name__ == '__main__':
    model_path = r'C:\Users\86181\Desktop\RTDETR-main\runsx\train\pcb\rtdetr-C\weights\best.pt'
    model = RTDETR(model_path) # 选择训练好的权重路径
    result = model.val(data=r'C:\Users\86181\Desktop\RTDETR-main\datasets_pcb完整 - 加工版\data.yaml',
